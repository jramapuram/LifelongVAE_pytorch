...
def get_launch_spec(args, custom_zone=None):
    ...
    # tack on IOPS, needs special Volume
    # fast IOPS = 'io1' w/ 5000 IOPS
    # Consider 'VolumeType': 'gp2', 'io1'
    if args.storage_iops is not None:
        storage_dict['Ebs']['VolumeType'] = 'io1'
        storage_dict['Ebs']['Iops'] = args.storage_iops
